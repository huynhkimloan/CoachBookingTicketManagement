...
<form id="submitFormEmployee" onsubmit="submitUserEmployee()" style="width: 70%; margin: 10px auto" acceptCharset="UTF-8" novalidate>
    <div class="form-group mb-3">
        <label for="name" class="form-label">Tên nhân viên<span class="asterisc">*</span></label>
    ...
    <div class="form-group mb-3">
        <label for="email" class="form-label">Email<span class="asterisc">*</span></label>
    ...
    <div class="form-group mb-3">
        <label for="phone" class="form-label">Số điện thoại<span class="asterisc">*</span></label>
    ...
    <div class="form-group mb-3">
        <label for="identityCard" class="form-label">CMND/CCCD<span class="asterisc">*</span></label>
    ...
    <div class="form-group mb-3">
        <label for="address" class="form-label">Địa chỉ<span class="asterisc">*</span></label>
    ...
    <div class="form-group mb-3">
        <label for="dateOfBirth" class="form-label">Ngày tháng năm sinh<span class="asterisc">*</span></label>
    ...
    <div class="form-group mb-3">
        <label for="username" class="form-label">Tên đăng nhập<span class="asterisc">*</span></label>
    ...
    <div class="form-group mb-3">
        <label for="password" class="form-label">Mật khẩu<span class="asterisc">*</span></label>
    ...
    <div class="form-group mb-3">
        <label for="confirmPassword">Xác nhận mật khẩu<span class="asterisc">*</span></label>
    ...
    <div class="form-group mb-3">
        <label for="avt" class="form-label">Ảnh đại diện<span class="asterisc">*</span></label>
        <input class="form-control" required type="file" id="upload_avatar">
    </div>
    <div class="form-group mb-3">
        <label for="userrole" class="form-label">Vai trò<span class="asterisc">*</span></label>
    ...
    <div class="form-group">
        ...
        <a href="<c:url value="/admin/employees/addemployee" />" class="btn btn-info" style="margin-top: -13px;" type="button" data-toggle="tooltip" 
           data-placement="top" title="Quay lại"><i class="fas fa-undo"></i></a>

        <a href="<c:url value="/admin/employees/list" />" class="btn btn-secondary" style="margin-top: -13px;" type="button" data-toggle="tooltip" 
