...
<form:form id="formDriver" style="width: 70%; margin: 10px auto" modelAttribute="driver">
    <div class="mb-3">
...
<div style="margin-left: 160px">
    <button class="btn btn-warning" onclick="updateDriver()" style="width: 6%">Sửa</button>   
