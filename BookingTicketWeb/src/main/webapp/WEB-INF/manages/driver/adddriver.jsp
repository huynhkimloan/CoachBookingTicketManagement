...
<form id="submitFormDriver" style="width: 70%; margin: 10px auto" onsubmit="submitUserDriver()" acceptCharset="UTF-8" novalidate>
    <div class="form-group mb-3">
        <label for="name" class="form-label">Tên tài xế<span class="asterisc">*</span></label>
    ...
    <div class="form-group mb-3">
        <label for="license" class="form-label">Hạng bằng lái xe<span class="asterisc">*</span></label>
    ...
    <div class="form-group">
        ...
        <a href="<c:url value="/admin/drivers/adddriver" />" class="btn btn-info" style="margin-top: -13px;" type="button" data-toggle="tooltip" 
           data-placement="top" title="Quay lại"><i class="fas fa-undo"></i></a>

        <a href="<c:url value="/admin/drivers/list" />" class="btn btn-secondary" style="margin-top: -13px;" type="button" data-toggle="tooltip" 
