...
<c:url value="/ad/driverdetails/editdriver" var="edit" />
<form:form action="${edit}" style="width: 70%; margin: 10px auto" modelAttribute="driver" method="post">
    <div class="mb-3">
    ...
    <div>
        ...
        <a href="<c:url value="/ad/driverdetails/list" />" class="btn btn-info" style="margin-top: -13px;" type="button" data-toggle="tooltip" 
